...
class GoiEnerData(Dataset):
    def __init__(
        ...
        self.postal_code = self.df["postal_code"]
...
class GoiEnerDataModule(pl.LightningDataModule):
    """
    GoiEner data module
    """
    ...
    def setup(self, stage=""):
        ...
        if self.outlier:
            self.outlier_dataset = GoiEnerData(
